...
export const records = [
  ...
  .concat(
    [
      ...
      "g-6/c/1753-ekrany-projekcyjne.html?f4345-przeznaczenie=96796-kino-domowe",
      ...
      "g-64/c/2960-roboty-sprzatajace.html?producent=1009-dji&producent=2315-dreame",
  ...
  .concat(
    [
      ...
      "g-64/c/1786-odkurzacze.html?producent=546-karcher",
  ...
  .concat(
    [
      ...
      "category=ekspresy-cisnieniowe&__=jura",
      ...
      "category=kamery-ip-do-monitoringu&__=ubiquiti",
      ...
      "category=laptopy-i-netbooki&__=Apple&_n=14&_hz=34%2C22%2C21%2C23%2C20%2C19",
      ...
      "category=odkurzacze-automatyczne&__=dreame",
      ...
      "category=roboty-do-mycia-okien",
      ...
      "category=urzadzenia-wielofunkcyjne&__=Canon&_h=3%2C2",
      ...
      "category=zasilacze-do-laptopow&__=Apple",
      ...
      .map(
        (path) =>
          `https://www.euro.com.pl/rest/api/products/search?startFrom=0&numberOfItems=22&${path}&developSearchMode=false&orderBy=POPULARITY&direction=ASC`,
      )
      .map((url, i) => ({
        blocked: true,
        data: {
  ...
  .concat(
    [
      ...
      "product-pol-20778-Odkurzacz-Bosch-AdvancedVac-18V-8.html",
